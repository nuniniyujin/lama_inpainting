...
def train_loop_Wassertstein(model, optimizer_g, optimizer_d, train_dataloader,
        test_dataloader, LAMA_loss, device, model_base_dir, image_base_dir,
        epochs=50, val_rate = 10, sav_rate=200, verbose=True,
        display_results=True, WEIGHT_CLIP=0.01, disc_iter=5,
        clip_weights=False):
